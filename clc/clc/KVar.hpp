...
public:
    ...
    bool load_file(std::string filename, long& fail_line);
    bool load_KV1(std::string filename);
    bool load_KV2(std::string filename);
    bool load_KV3(std::string filename);
    bool load_KV1(std::string filename, long& fail_line);
    bool load_KV2(std::string filename, long& fail_line);
    bool load_KV3(std::string filename, long& fail_line);
